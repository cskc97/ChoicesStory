...
public class PlayCricketAgainstPoliceQuartersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_cricket_against_police_quarters);

        ButterKnife.bind(this);

        Picasso.with(getApplicationContext()).load(R.drawable.cricketground).fit().centerCrop().into(banner);
