...
public class PaperMillActivity extends AppCompatActivity {

    @BindView(R.id.imageView)ImageView banner;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_paper_mill);
        ButterKnife.bind(this);



        Picasso.with(getApplicationContext()).load(R.drawable.papermill).fit().centerCrop().into(banner);
    }
